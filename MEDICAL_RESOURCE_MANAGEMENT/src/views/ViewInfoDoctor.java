 ...
 */
public class ViewInfoDoctor extends javax.swing.JFrame {

    /**
     * Creates new form ViewInfoDoctor
     */
    public ViewInfoDoctor() {
        initComponents();
    }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        DefaultTableModel dtm = (DefaultTableModel) tableDoctor.getModel();
        if(tableDoctor.getSelectedRowCount() == 1) {
            int id = Integer.parseInt(dtm.getValueAt(tableDoctor.getSelectedRow(), 0).toString());
            for(int i=0;i<encounters.size();i++) 
            {
                if(encounters.get(i).getPatientID() == id) {
                    ...
                    enc.textHospName.setText(encounters.get(i).getHospitalName());
                    enc.textHospName.setEnabled(false);
                    ...
                    enc.textHR.setText(Float.toString(encounters.get(i).getHeartRate()));
            ...
            enc.show();
               ...
               if(tableDoctor.getSelectedRowCount() == 0) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewInfoDoctor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewInfoDoctor().setVisible(true);
            }
        });
    }
