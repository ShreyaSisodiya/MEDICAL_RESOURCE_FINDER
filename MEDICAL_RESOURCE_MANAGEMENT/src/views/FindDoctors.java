 ...
 */
public class FindDoctors extends javax.swing.JFrame {

    /**
     * Creates new form FindDoctors
     */
    public FindDoctors() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        comboDoctor.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { " ", " " }));

        jLabel3.setText("HOSPITALS");
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(comboHospital))
                .addGap(60, 60, 60)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(comboDoctor)
    ...
    private void comboHospitalActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_comboHospitalActionPerformed
        ...
        for (HashMap.Entry<String, Doctor> set : doctorMap.entrySet())
        {
            ...
            if(comboHospital.getSelectedItem().toString().equals(hos)) {
                comboDoctor.addItem(set.getValue().getFirstName());
            }
        }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
            ...
            for(HashMap.Entry<String, Doctor> set : doctorMap.entrySet()) 
            {               
                if(set.getValue().getFirstName().equals(comboDoctor.getSelectedItem())) 
                {
            ...
            Encounter enc = new Encounter(
                    patientMap.get(patUserName).getFirstName(),
                    comboDoctor.getSelectedItem().toString(),
                    jDateChooser1.getDate(), 
                    patientMap.get(patUserName).getPatientID(),
                    id, 
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FindDoctors.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FindDoctors().setVisible(true);
            }
        });
    }
    ...
    public javax.swing.JComboBox<String> comboHospital;
